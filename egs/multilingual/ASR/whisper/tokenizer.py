...
class Tokenizer:
    ...
    def __post_init__(self):
        ...
        sot_sequence = [sot]
        if self.concat:
            sot_sequence.append(sot + 1 + langs.index("zh"))
            sot_sequence.append(sot + 1 + langs.index("en"))
        else:
...
def get_tokenizer(
    ...
    *,
    ...
    if code_switch:
        return Tokenizer(encoding=encoding, language=language, task=task, concat=True)
    else:

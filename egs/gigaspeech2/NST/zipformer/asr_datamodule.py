...
class Gigaspeech2AsrDataModule:
    """
    ...
    def train_cuts(self) -> CutSet:
        ...
        split_lis = [item for item in split_lis if os.path.isdir(os.path.join(self.args.manifest_dir, item)) and item != "IndonesianFairyTales_split_Z_split" and "fulldramaindo" not in item]
        cut_lis = []

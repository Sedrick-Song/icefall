...
def run(rank, world_size, args):
    ...
    train_cuts = stutter_speech.train_all_cuts()
    valid_cuts = stutter_speech.valid_cuts()
    ...
    train_dl = stutter_speech.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    valid_dl = stutter_speech.valid_dataloaders(valid_cuts)
